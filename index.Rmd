...
- Introduction: 
    ...
    - [Lecture 2:](content/01_introduction/lecture_02.html) R functionality. Loading in data. 
...
- Basics, correlation, regression, summaries, reliability analysis: 
    - [Lecture 1:](content/02_modelling/lecture_01.html) 
    - [Practical 1:](content/02_modelling/practical_01.html) 
...
- ggplot2: 
    - [Lecture 1:](content/03_data_visualisation/lecture_01.html) 
...
- ggplot2: 
    - [Lecture 1:](content/04_SEMn/lecture_01.html) 
